        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-24 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            <div className="inline-flex items-center justify-center lg:justify-start mb-3 sm:mb-4 md:mb-6">
              <span className="text-[9px] sm:text-[10px] md:text-xs font-black tracking-[0.3em] text-gray-400 uppercase">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 font-medium mb-6 sm:mb-8 md:mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-2xl mx-auto lg:mx-0">
              <a 
                ...
                className="group inline-flex items-center justify-center px-5 sm:px-6 py-3 bg-[#e9a459] text-white text-xs sm:text-sm font-bold tracking-wide hover:shadow-2xl hover:scale-105 transition-all duration-300 rounded-md whitespace-nowrap"
              >
                Iniciar Consulta
              ...
              <Link 
                ...
                className="inline-flex items-center justify-center px-5 sm:px-6 py-3 border-2 border-gray-900 text-gray-900 text-xs sm:text-sm font-bold tracking-wide hover:bg-gray-900 hover:text-white transition-all duration-300 rounded-md whitespace-nowrap"
              >
