        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto text-center mb-16">
            <a 
              ...
              className="inline-flex items-center justify-center group px-12 py-6 bg-gradient-to-r from-primary to-primary-light text-white text-base font-medium tracking-wide hover:shadow-lg hover:scale-105 transition-all duration-300 w-full sm:w-auto"
            >
          ...
          <div className="border-t border-gray-100 pt-16"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="name" className="block text-xs font-light text-gray-400 uppercase tracking-wider mb-3">
                    Nombre completo
                  </label>
                  <input
                    type="text"
