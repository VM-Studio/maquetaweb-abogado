        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 mb-4 sm:mb-5">
              ¿Listo para resolver tu <span className="text-[#e9a459]">sucesión</span>?
            </h1>
          ...
          <div className="max-w-xl mx-auto text-center mb-12 sm:mb-16">
            <a 
              href="https://wa.me/5493515186325?text=Hola,%20quiero%20resolver%20mi%20sucesión"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center group w-full sm:w-auto px-8 py-4 bg-[#e9a459] text-white text-base sm:text-lg font-bold hover:shadow-xl hover:scale-105 transition-all duration-300 rounded-md"
            >
            ...
            <p className="text-sm sm:text-base font-medium text-gray-600 mt-4 sm:mt-5">
              Atendemos consultas de <span className="text-[#e9a459] font-bold">lunes a viernes</span> de 9 a 18 hs.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16">
            ...
            <div>
              {submitStatus === 'success' && (
                <div className="mb-6 p-4 sm:p-5 bg-[#e9a459] border border-[#e9a459] rounded-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-0 py-3 border-0 border-b border-gray-300 focus:border-[#e9a459] focus:ring-0 outline-none transition bg-transparent text-gray-900 text-sm sm:text-base"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-0 py-3 border-0 border-b border-gray-300 focus:border-[#e9a459] focus:ring-0 outline-none transition resize-none bg-transparent text-gray-900 text-sm sm:text-base"
                ...
                <button
                  ...
                  className="w-full py-4 bg-[#e9a459] text-white text-base sm:text-lg font-bold hover:shadow-xl hover:scale-105 transition-all duration-300 disabled:bg-gray-400 disabled:cursor-not-allowed rounded-md"
                >
            ...
            <div className="lg:border-l lg:border-gray-200 lg:pl-12">
              <div className="space-y-8 sm:space-y-10">
                <div>
                  <h3 className="text-xs font-bold text-[#e9a459] uppercase tracking-wider mb-3">
                    Teléfono
                  </h3>
                  <a 
                    href="tel:+5493515186325" 
                    className="text-lg sm:text-xl font-bold text-gray-900 hover:text-[#e9a459] transition-colors"
                  >
                    +54 9 351 518-6325
                  </a>
                ...
                <div>
                  ...
                  <a 
                    href="mailto:ab.augustofili@gmail.com" 
                    className="text-lg sm:text-xl font-bold text-gray-900 hover:text-[#e9a459] transition-colors break-all"
                  >
              ...
              <div className="mt-12 pt-12 border-t border-gray-200">
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  ...
                  <span className="font-bold"> Primera consulta incluida en el costo del trabajo</span> y sin compromiso.
                </p>
              </div>
            </div>
          </div>
