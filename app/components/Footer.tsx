      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-10 sm:py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8 sm:mb-10 md:mb-12">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a href="tel:+5493515186325" className="text-sm font-bold text-white hover:text-[#e9a459] transition-colors">
                  +54 9 351 518-6325
                </a>
              </li>
        ...
        <div className="pt-6 sm:pt-8 border-t border-gray-800">
          <p className="text-xs sm:text-sm font-medium text-gray-500 text-center">
            © {new Date().getFullYear()} <span className="font-bold text-gray-400">AUGUSTO Filí & Asociados</span>. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
