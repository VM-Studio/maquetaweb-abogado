          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-2xl mx-auto lg:mx-0">
              <a 
                ...
                className="group inline-flex items-center justify-center px-5 sm:px-6 py-3 bg-[#d5c5ac] text-white text-xs sm:text-sm font-bold tracking-wide hover:shadow-2xl hover:scale-105 transition-all duration-300 rounded-md whitespace-nowrap"
              >
                Iniciar Consulta
